...
**Внешние зависимости Application оформляются портами.** Интерфейс, который реализует
адаптер из `Infrastructure` или транспорта, живёт в `Bugget.Application/**/Ports` — это
единое соглашение для направления зависимости из ADR-0001. Внутренние application-сервисы
и оркестрационные интерфейсы портами механически не становятся.
