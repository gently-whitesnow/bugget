...
| [0016](0016-harness-cli-frame.md) | Рамка качества — harness CLI вместо собственных скриптовых бюджетов | Accepted | 2026-09-17 |
| [0017](0017-ports-and-use-case-contracts.md) | Порты внешних зависимостей и контракты use-case прикладного слоя | Accepted | 2026-09-17 |
