...
const faq = [
  ['Как установить Bugget?', 'Актуальная инструкция развёртывания и состав сервисов находятся в README репозитория. Bugget рассчитан на self-hosted установку в вашей инфраструктуре.'],
  ...
  ['Как Bugget уменьшает трение при создании?', 'Минимум полей, вложения, понятная история событий и единый поток обсуждения.'],
  ...
  return <main className="page-shell">
    ...
    <header className="header">
      <div className="header-inner">
        <a className="brand" href="#top" aria-label="Bugget — на главную"><Image className="brand-icon" src="/android-chrome-192x192.png" width={20} height={20} alt="" />Bugget</a>
        <nav aria-label="Основная навигация"><a href="#how">Как это работает</a><a href="#why">Почему Bugget</a><a href="#faq">FAQ</a></nav>
    ...
    <div className="content" id="top">
      <section className="hero" id="content">
        ...
        <Image className="example-image" src="/example.png" width={2940} height={1502} priority alt="Интерфейс Bugget: репорт с багами, шагами, ожидаемым и фактическим результатом" />
      </section>
      ...
      <section className="install-callout"><h2>Разверните Bugget у себя</h2><p>Исходный код открыт под лицензией MIT. Данные и настройки остаются в инфраструктуре вашей команды.</p><div className="cta-row"><GitHubLink className="button button-primary">Открыть репозиторий</GitHubLink><a className="button button-secondary" href={`${repositoryUrl}/blob/main/LICENSE`} target="_blank" rel="noreferrer">Лицензия MIT</a></div></section>
    ...
    <footer><div><span>© 2026 Bugget</span><GitHubLink>GitHub</GitHubLink><a href={`${repositoryUrl}/blob/main/LICENSE`} target="_blank" rel="noreferrer">MIT License</a></div></footer>
  </main>;
}
