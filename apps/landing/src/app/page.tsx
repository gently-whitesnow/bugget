...
export default function Home() {
  return <main className="page-shell">
    ...
    <footer><div><span>© 2026 Bugget</span><GitHubLink>GitHub</GitHubLink><a href={`${repositoryUrl}/blob/master/LICENSE`} target="_blank" rel="noreferrer">MIT License</a></div></footer>
  </main>;
}
