...
public static class SwaggerConfiguration
{
            ...
            foreach (var assembly in new[]
                     {
                         ...
                         typeof(Bugget.Api.Users.Controllers.ApiController).Assembly,
                         typeof(Bugget.Api.Authorization.AuthorizationSchemeNames).Assembly,
                     })
            {
    ...
    {
        if (assembly == typeof(Bugget.Api.Users.Controllers.ApiController).Assembly
            || assembly == typeof(Bugget.Api.Users.MattermostOAuth.MattermostOAuthController).Assembly)
        {
            return UsersDoc;
        }

        if (assembly == typeof(Bugget.Api.Authorization.AuthorizationSchemeNames).Assembly
            || assembly == typeof(Bugget.Api.Authorization.Oidc.OidcController).Assembly
            || assembly == typeof(Bugget.Api.Authorization.Fake.FakeController).Assembly)
        {
