...
/// <summary>
/// Числовое представление домена ↔ enum провода модуля reports: строка живёт только на HTTP-границе (ADR-0013).
/// Соответствие поимённое, а не приведением типа: совпадение порядка значений с числами домена — случайность,
/// <c>(int)</c> сломался бы на первом значении, вставленном в середину списка.
/// Неизвестное число наружу не уходит: «ближайшее» значение вместо него — тихая порча данных у клиента.
/// </summary>
