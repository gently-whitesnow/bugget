...
using AnalyticsPhaseName = Bugget.Analytics.Contracts.Generated.PhaseName;
using ReportContracts = Bugget.Reports.Contracts.Generated;
...
/// поэтому маппер живёт в Web-проекте, не в Bugget.BO.
///
...
/// остались в <c>Bugget.Analytics.Contracts.Generated</c>. Алиасим оба
