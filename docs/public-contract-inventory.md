...
Исторически пять legacy TTL-invite маршрутов были сознательно сняты вместе с их
единственным клиентом в [PR #33](https://github.com/gently-whitesnow/bugget/pull/33).
Совместимость не восстанавливается и ADR не создаётся по явному решению владельца
в MAIN-263: этот контур признан забытым SaaS-атавизмом.
